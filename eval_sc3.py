...
def run_benchmark():
    ...
    binary_results_df.to_excel(f'eval_results_sc3_binary_{timestamp}.xlsx', index=False)
    neutral_results_df.to_excel(f'eval_results_sc3_neutral_{timestamp}.xlsx', index=False)
