...
def run_benchmark():
    ...
    binary_results_df.to_excel(f'eval_results_sc2_binary_{timestamp}.xlsx', index=False)
    neutral_results_df.to_excel(f'eval_results_sc2_neutral_{timestamp}.xlsx', index=False)
